...
const LIENS = [
  ...
  { to: '/synchro', label: 'Synchronisation', icon: RefreshCw },
...
export default function Nav() {
  ...
  return (
    <nav className="flex shrink-0 flex-col justify-between border-b border-slate-200 bg-white px-4 py-4 lg:sticky lg:top-0 lg:h-screen lg:w-64 lg:border-r lg:border-b-0">
      ...
      <button
        onClick={logout}
        className="mt-4 rounded-xl border border-slate-300 px-3 py-1.5 text-sm text-slate-700 hover:bg-or-50 focus:outline-none focus:ring-2 focus:ring-or-400 focus:ring-offset-2"
      >
        Déconnexion
      </button>
    </nav>
